        ...
        context: &C) -> Result<GetRatesResponse, ApiError>
    {
        ...
        let query_string = {
            ...
            if let Some(param_period) = param_period {
                query_string.append_pair("period",
                    &param_period.to_string());
            }
            ...
            if let Some(param_base_datetime) = param_base_datetime {
                query_string.append_pair("base_datetime",
                    &param_base_datetime.to_string());
            }
            query_string.finish()
        };
